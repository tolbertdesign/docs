<template>
  <div class="flex flex-wrap-reverse">
    <div
      :class="[
        'w-full py-4 lg:w-3/4 lg:pt-8 lg:pb-4 dark:border-gray-800',
        {
          'lg:border-r': doc.toc && doc.toc.length,
        },
      ]"
    >
      <article class="lg:px-8">
        <h1 class="mb-4 text-4xl font-black leading-none">
          {{ doc.title }}
        </h1>
...
.nuxt-content h2 {
  ...
  & > a {
    ...
    &::before {
      content: '#';
      @apply text-primary-500 font-normal -ml-6 pr-1 absolute opacity-100;
    }
  }
...
.nuxt-content h3 {
  ...
  & > a {
    ...
    &::before {
      content: '#';
      @apply text-primary-500 font-normal -ml-5 pr-1 absolute opacity-100;
    }
  }
